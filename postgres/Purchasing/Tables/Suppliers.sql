...
CREATE SEQUENCE IF NOT EXISTS sequences.supplier_id_seq START 1 INCREMENT 1;
...
CREATE TABLE purchasing.suppliers (
    ...
    CONSTRAINT FK_Purchasing_Suppliers_DeliveryMethodID_Application_DeliveryMethods FOREIGN KEY (DeliveryMethodID) REFERENCES application.delivery_methods (DeliveryMethodID),
    ...
    CONSTRAINT FK_Purchasing_Suppliers_SupplierCategoryID_Purchasing_SupplierCategories FOREIGN KEY (SupplierCategoryID) REFERENCES purchasing.supplier_categories (SupplierCategoryID),

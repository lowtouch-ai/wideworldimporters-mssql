...
COMMENT ON TABLE application.transaction_types IS 'Types of customer, supplier, or stock transactions (ie: invoice, credit note, etc.)';
COMMENT ON COLUMN application.transaction_types.TransactionTypeID IS 'Numeric ID used for reference to a transaction type within the database';
COMMENT ON COLUMN application.transaction_types.TransactionTypeName IS 'Full name of the transaction type';

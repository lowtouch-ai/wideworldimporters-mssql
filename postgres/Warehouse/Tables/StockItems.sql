...
CREATE SEQUENCE IF NOT EXISTS sequences.stock_item_id_seq START 1 INCREMENT 1;
...
CREATE TABLE warehouse.stockitems (
    ...
    Tags                   TEXT             NULL, -- NOTE: was a non-persisted computed column (json_query on CustomFields.Tags)
    SearchDetails          TEXT             NULL, -- NOTE: was a non-persisted computed column (concat of StockItemName + MarketingComments)

...
CREATE OR REPLACE FUNCTION webapi.insert_customer_categories_from_json(
    ...
    p_user_id             integer
) RETURNS TABLE(customercategoryid integer) AS $$
BEGIN
    RETURN QUERY
    INSERT INTO sales.customer_categories(customercategoryname, lasteditedby)
    ...
    RETURNING customer_categories.customercategoryid;
END;
$$ LANGUAGE plpgsql;

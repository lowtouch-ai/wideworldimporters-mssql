...
LEFT JOIN sales.customer_categories AS cat ON deal.CustomerCategoryID = cat.CustomerCategoryID
LEFT JOIN sales.buying_groups AS bg ON deal.BuyingGroupID = bg.BuyingGroupID;

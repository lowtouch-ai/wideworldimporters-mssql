...
LEFT JOIN application.transaction_types AS tt ON ct.TransactionTypeID = tt.TransactionTypeID
LEFT JOIN application.payment_methods AS pm ON ct.PaymentMethodID = pm.PaymentMethodID;

...
COMMENT ON COLUMN sales.buying_groups.BuyingGroupID IS 'Numeric ID used for reference to a buying group within the database';
COMMENT ON COLUMN sales.buying_groups.BuyingGroupName IS 'Full name of a buying group that customers can be members of';

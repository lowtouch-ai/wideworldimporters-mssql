...
COMMENT ON TABLE sales.customercategories IS 'Categories for customers (ie restaurants, cafes, supermarkets, etc.)';
COMMENT ON COLUMN sales.customercategories.CustomerCategoryID IS 'Numeric ID used for reference to a customer category within the database';
COMMENT ON COLUMN sales.customercategories.CustomerCategoryName IS 'Full name of the category that customers can be assigned to';
